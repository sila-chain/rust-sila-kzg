...
proc sila_kzg_das_context_new*(use_precomp: bool): ptr DASContext {.importc: "sila_kzg_das_context_new".}
...
proc sila_kzg_das_context_free*(ctx: ptr DASContext): void {.importc: "sila_kzg_das_context_free".}
...
# - The caller must ensure that the pointer is valid. If the pointer is null, this method will return early.
# - The caller should also avoid a double-free by setting the pointer to null after calling this method.
proc sila_kzg_free_error_message*(c_message: pointer): void {.importc: "sila_kzg_free_error_message".}
...
proc sila_kzg_blob_to_kzg_commitment*(ctx: ptr DASContext,
                                     blob: pointer,
                                     outx: pointer): CResult {.importc: "sila_kzg_blob_to_kzg_commitment".}
...
# - This implementation will check if the ctx pointer is null, but it will not check if the other arguments are null.
#   If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
proc sila_kzg_compute_cells_and_kzg_proofs*(ctx: ptr DASContext,
                                           blob: pointer,
                                           out_cells: ptr pointer,
                                           out_proofs: ptr pointer): CResult {.importc: "sila_kzg_compute_cells_and_kzg_proofs".}
...
# - This implementation will check if the ctx pointer is null, but it will not check if the other arguments are null.
#   If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
proc sila_kzg_compute_cells*(ctx: ptr DASContext,
                            blob: pointer,
                            out_cells: ptr pointer): CResult {.importc: "sila_kzg_compute_cells".}
...
# - This implementation will check if the ctx pointer is null, but it will not check if the other arguments are null.
#   If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
proc sila_kzg_verify_cell_kzg_proof_batch*(ctx: ptr DASContext,
                                          ...
                                          proofs: ptr pointer,
                                          verified: pointer): CResult {.importc: "sila_kzg_verify_cell_kzg_proof_batch".}
...
# - This implementation will check if the ctx pointer is null, but it will not check if the other arguments are null.
#   If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
proc sila_kzg_recover_cells_and_proofs*(ctx: ptr DASContext,
                                       cells_length: uint64,
                                       cells: ptr pointer,
                                       cell_indices_length: uint64,
                                       cell_indices: pointer,
                                       out_cells: ptr pointer,
                                       out_proofs: ptr pointer): CResult {.importc: "sila_kzg_recover_cells_and_proofs".}

proc sila_kzg_constant_bytes_per_cell*(): uint64 {.importc: "sila_kzg_constant_bytes_per_cell".}

proc sila_kzg_constant_bytes_per_proof*(): uint64 {.importc: "sila_kzg_constant_bytes_per_proof".}

proc sila_kzg_constant_cells_per_ext_blob*(): uint64 {.importc: "sila_kzg_constant_cells_per_ext_blob".}
...
# - This implementation will check if the ctx pointer is null, but it will not check if the other arguments are null.
#   If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
proc sila_kzg_compute_kzg_proof*(ctx: ptr DASContext,
                                blob: pointer,
                                z: pointer,
                                out_proof: pointer,
                                out_y: pointer): CResult {.importc: "sila_kzg_compute_kzg_proof".}
...
# - This implementation will check if the ctx pointer is null, but it will not check if the other arguments are null.
#   If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
proc sila_kzg_compute_blob_kzg_proof*(ctx: ptr DASContext,
                                     blob: pointer,
                                     commitment: pointer,
                                     out_proof: pointer): CResult {.importc: "sila_kzg_compute_blob_kzg_proof".}
...
# - This implementation will check if the ctx pointer is null, but it will not check if the other arguments are null.
#   If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
proc sila_kzg_verify_kzg_proof*(ctx: ptr DASContext,
                               commitment: pointer,
                               z: pointer,
                               y: pointer,
                               proof: pointer,
                               verified: pointer): CResult {.importc: "sila_kzg_verify_kzg_proof".}
...
# - This implementation will check if the ctx pointer is null, but it will not check if the other arguments are null.
#   If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
proc sila_kzg_verify_blob_kzg_proof*(ctx: ptr DASContext,
                                    blob: pointer,
                                    commitment: pointer,
                                    proof: pointer,
                                    verified: pointer): CResult {.importc: "sila_kzg_verify_blob_kzg_proof".}
...
# - This implementation will check if the ctx pointer is null, but it will not check if the other arguments are null.
#   If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
proc sila_kzg_verify_blob_kzg_proof_batch*(ctx: ptr DASContext,
                                          blobs_length: uint64,
                                          blobs: ptr pointer,
                                          commitments_length: uint64,
                                          commitments: ptr pointer,
                                          proofs_length: uint64,
                                          proofs: ptr pointer,
                                          verified: pointer): CResult {.importc: "sila_kzg_verify_blob_kzg_proof_batch".}
