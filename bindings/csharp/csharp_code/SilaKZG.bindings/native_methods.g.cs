...
namespace SilaKZG.Native
{
    ...
    {
        const string __DllName = "c_sila_kzg";
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_das_context_new", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern DASContext* sila_kzg_das_context_new([MarshalAs(UnmanagedType.U1)] bool use_precomp);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_das_context_free", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void sila_kzg_das_context_free(DASContext* ctx);
        ...
        ///  - The caller should also avoid a double-free by setting the pointer to null after calling this method.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_free_error_message", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void sila_kzg_free_error_message(byte* c_message);
        ...
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_blob_to_kzg_commitment", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_blob_to_kzg_commitment(DASContext* ctx, byte* blob, byte* @out);
        ...
        ///    If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_compute_cells_and_kzg_proofs", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_compute_cells_and_kzg_proofs(DASContext* ctx, byte* blob, byte** out_cells, byte** out_proofs);
        ...
        ///    If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_compute_cells", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_compute_cells(DASContext* ctx, byte* blob, byte** out_cells);
        ...
        ///    If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_verify_cell_kzg_proof_batch", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_verify_cell_kzg_proof_batch(DASContext* ctx, ulong commitments_length, byte** commitments, ulong cell_indices_length, ulong* cell_indices, ulong cells_length, byte** cells, ulong proofs_length, byte** proofs, bool* verified);
        ...
        ///    If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_recover_cells_and_proofs", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_recover_cells_and_proofs(DASContext* ctx, ulong cells_length, byte** cells, ulong cell_indices_length, ulong* cell_indices, byte** out_cells, byte** out_proofs);

        [DllImport(__DllName, EntryPoint = "sila_kzg_constant_bytes_per_cell", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong sila_kzg_constant_bytes_per_cell();

        [DllImport(__DllName, EntryPoint = "sila_kzg_constant_bytes_per_proof", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong sila_kzg_constant_bytes_per_proof();

        [DllImport(__DllName, EntryPoint = "sila_kzg_constant_cells_per_ext_blob", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern ulong sila_kzg_constant_cells_per_ext_blob();
        ...
        ///    If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_compute_kzg_proof", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_compute_kzg_proof(DASContext* ctx, byte* blob, byte* z, byte* out_proof, byte* out_y);
        ...
        ///    If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_compute_blob_kzg_proof", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_compute_blob_kzg_proof(DASContext* ctx, byte* blob, byte* commitment, byte* out_proof);
        ...
        ///    If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_verify_kzg_proof", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_verify_kzg_proof(DASContext* ctx, byte* commitment, byte* z, byte* y, byte* proof, bool* verified);
        ...
        ///    If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_verify_blob_kzg_proof", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_verify_blob_kzg_proof(DASContext* ctx, byte* blob, byte* commitment, byte* proof, bool* verified);
        ...
        ///    If the other arguments are null, this method will dereference a null pointer and result in undefined behavior.
        /// </summary>
        [DllImport(__DllName, EntryPoint = "sila_kzg_verify_blob_kzg_proof_batch", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern CResult sila_kzg_verify_blob_kzg_proof_batch(DASContext* ctx, ulong blobs_length, byte** blobs, ulong commitments_length, byte** commitments, ulong proofs_length, byte** proofs, bool* verified);
